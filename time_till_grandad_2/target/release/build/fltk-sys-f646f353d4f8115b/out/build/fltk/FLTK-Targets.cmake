...
set_target_properties(fltk PROPERTIES
  INTERFACE_LINK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libdl.so;-lpthread;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so;/usr/lib/x86_64-linux-gnu/libXinerama.so;/usr/lib/x86_64-linux-gnu/libXfixes.so;/usr/lib/x86_64-linux-gnu/libXcursor.so;/usr/lib/x86_64-linux-gnu/libXrender.so;/usr/lib/x86_64-linux-gnu/libpango-1.0.so;/usr/lib/x86_64-linux-gnu/libpangoxft-1.0.so;/usr/lib/x86_64-linux-gnu/libpangocairo-1.0.so;/usr/lib/x86_64-linux-gnu/libcairo.so;/usr/lib/x86_64-linux-gnu/libgobject-2.0.so;/usr/lib/x86_64-linux-gnu/libXft.so;/usr/lib/x86_64-linux-gnu/libfontconfig.so"
)
...
set_target_properties(fluid PROPERTIES
  IMPORTED_LOCATION_RELEASE "/workspace/firstRust/time_till_grandad_2/target/release/build/fltk-sys-f646f353d4f8115b/out/build/fltk/bin/fluid"
  )
...
set_target_properties(fltk_z PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/workspace/firstRust/time_till_grandad_2/target/release/build/fltk-sys-f646f353d4f8115b/out/build/fltk/lib/libfltk_z.a"
  )
...
set_target_properties(fltk_jpeg PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "/workspace/firstRust/time_till_grandad_2/target/release/build/fltk-sys-f646f353d4f8115b/out/build/fltk/lib/libfltk_jpeg.a"
  )
...
set_target_properties(fltk_png PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "/workspace/firstRust/time_till_grandad_2/target/release/build/fltk-sys-f646f353d4f8115b/out/build/fltk/lib/libfltk_png.a"
  )
...
set_target_properties(fltk PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/workspace/firstRust/time_till_grandad_2/target/release/build/fltk-sys-f646f353d4f8115b/out/build/fltk/lib/libfltk.a"
  )
...
set_target_properties(fltk_forms PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/workspace/firstRust/time_till_grandad_2/target/release/build/fltk-sys-f646f353d4f8115b/out/build/fltk/lib/libfltk_forms.a"
  )
...
set_target_properties(fltk_images PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/workspace/firstRust/time_till_grandad_2/target/release/build/fltk-sys-f646f353d4f8115b/out/build/fltk/lib/libfltk_images.a"
  )
